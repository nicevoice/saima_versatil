...
function init() {
	...
	askb = 1;
	e = navigator.language; - 1 < document.URL.indexOf("page") ? (e = ["title_jmp_nolink.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp_nolink.png"], canvas.style.backgroundImage = "url(skj/title_jmp_nolink.jpg)",canvas.style.backgroundRepeat = "no-repeat;", shms1 = "Browser game[SKY JUMP] SCORE=", shms2 = "Browser game[SKY JUMP]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?") : -1 < e.indexOf("ja") ? (e = ["title_jmp_jp.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp_jp.png"], canvas.style.backgroundImage = "url(skj/title_jmp_jp.jpg)",canvas.style.backgroundRepeat = "no-repeat;", shms1 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v SCORE=", shms2 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v", shms3 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�𗧂�TIPS���Q�b�g���悤�I", shms4 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�A�C�e�����Q�b�g���悤�I") : (e = ["title_jmp.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp.png?d"], canvas.style.backgroundImage = "url(skj/title_jmp.jpg)", canvas.style.backgroundRepeat = "no-repeat;",shms1 = "Browser game[SKY JUMP] SCORE=", shms2 = "Browser game[SKY JUMP]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?");
	img0 = new Image;
	img0.src = "skj/" + e[0];
...
function Press(e) {
	tch = 1;
	var t = e.x / wdpr | 0;
	width_load = window.innerWidth/320;
	height_load = window.innerHeight/416;
	switch (s) {
	case 1:
		mv(t);
		break;
	case 0:
		...
		} (), ralp()), canvas.style.backgroundImage = "none",canvas.style.backgroundRepeat = "no-repeat;");
		break;
	case 2:
		f = e.y / wdpr | 0;
		t = t/width_load;
