		...
		<div class="main">
			...
			<div class="contxt cont-artical">
				<?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?><div class="box-cont box-list-hotel">
					<div class="list-li" onclick="javascript:window.location.href='<?php echo U('Hotels/selectdate',array('token' => $_GET['token'], 'wecha_id' => $wecha_id, 'cid' => $com['id']));?>'">
					<div class="hd"><img src="<?php echo ($com['logourl']); ?>"></div>
					<div class="bd">
					<b><?php echo ($com['name']); ?></b>
					<p>
					<span class="tleft"><?php echo ($com['address']); ?></span>
					<span><em>￥<?php echo ($com['price']); ?></em>起</span>
					</p>
					<!-- <p><span>3条评论</span></p> -->
					</div>
