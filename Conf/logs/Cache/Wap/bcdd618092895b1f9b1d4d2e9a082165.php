...
<meta charset="utf-8">
<link href="./tpl/static/market/cate.css" rel="stylesheet" type="text/css" />
...
<section>
  <nav class="nav_for_list_ul">
    <div class="ofh">
      <ul>
            <?php $__FOR_START_2109097148__=1;$__FOR_END_2109097148__=count($info);for($i=$__FOR_START_2109097148__;$i < $__FOR_END_2109097148__;$i+=1){ ?><li <?php if($i == 4): ?>class="on"<?php endif; ?>></li><?php } ?>
