  ...
  <nav class="nav_for_list_ul">
    <div class="ofh">
      <ul>
		...
		<?php $__FOR_START_728194501__=1;$__FOR_END_728194501__=count($info);for($i=$__FOR_START_728194501__;$i < $__FOR_END_728194501__;$i+=1){ ?><li <?php if($i == 1): ?>class="on"<?php endif; ?>></li><?php } ?>
      </ul>
