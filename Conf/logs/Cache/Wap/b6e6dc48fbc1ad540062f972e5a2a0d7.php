			...
			<header>
				...
				<div class="header_2">
					<nav>
						<ul class="box">
							<li>
								<a href="<?php echo U('Forum/myContent',array('wecha_id'=>$_GET['wecha_id'],'token'=>$_GET['token']));?>">
									<label>帖子</label>
							...
							<li>
								<a href="<?php echo U('Forum/myMessage',array('wecha_id'=>$_GET['wecha_id'],'token'=>$_GET['token']));?>" class="on">
									<label>消息</label>
			...
			<div class="body">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><article>
						<header>
							<ul class="tbox">
								<li>
									<a href="<?php echo U('Forum/otherUser',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'],'uid'=>$list['fromuid']));?>" class="head_img">
			...
			<footer>
				<section class="nav_footer">
					<ul class="box">
						...
						<li>
							<a href="<?php echo U('Forum/add',array('wecha_id'=>$_GET['wecha_id'],'token'=>$_GET['token']));?>" class="nav_add">
