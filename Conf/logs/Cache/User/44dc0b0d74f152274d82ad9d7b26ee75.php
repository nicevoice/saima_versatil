...
<div class="content">
          <div class="cLineB">
              <h4 class="left"><?php if($addtype == 'drive'): ?>预约试驾<?php else: ?>预约保养<?php endif; ?>  订单管理</h4>
          ...
          <input name="delall" type="hidden" value="del">
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($o["housetype"]); ?>  <?php if($o['type'] == 'drive'): ?>－预约试驾<?php elseif($o['type'] == 'maintain'): ?>- 预约保养<?php endif; ?> </td>
                        ...
                        <td class="norightborder"><a href="###" onclick="showIntroDetail(<?php echo ($o["id"]); ?>)">详细</a>  <a class="btn" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Car/manage_del',array('token'=>$o['token'],'id'=>$o['id'],'car'=>'car'));?>');"  title="删除">删除</a></td>
           ...
           <script>
            function showIntroDetail(id){
                art.dialog.open('<?php echo U('Car/reservation_uinfo',array('token'=>$token));?>&id='+id,{lock:false,title:'预约订单详情',width:700,height:420,yesText:'关闭',background: '#000',opacity: 0.87});
            }
        </script>
