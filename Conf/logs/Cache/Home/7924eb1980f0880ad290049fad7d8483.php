...
<head>
  ...
  <title>关于我们_艾米微中心™Vlianyun_微信营销推广行业领导品牌</title>
  <meta name="keywords"  content="艾米微中心™、关于我们"/>
  <meta name="description"  content="艾米微中心™（Vlianyun），是微信营销行业领导品牌，专注于提供微信营销、微信推广、微信运营等解决方案，助力企业微营销。"/>
...
<div class="body">
  ...
  <div class="clearfix article">
    <div class="wrap">
      ...
      <div class="edit-main">
        <h2>艾米微中心™（Vlianyun）——中国微营销行业解决方案领导品牌</h2>
        <p>艾米微中心™是国内首款最完备的微信营销行业解决方案，依托微信公众平台，为企业重新定义微信公众账号，解决企业线上线下（O2O）互动、口碑营销难题。目前深入挖掘的行业有餐饮、电商、医疗、旅游、汽车、房产、婚庆、影楼、牙医、教育、建材等行业解决方案。</p>
        <p>艾米微中心™Vlianyun，作为行业微营销解决方案，可帮助企业面向微信用户，建设自己的微信官网、派发微信会员卡特权服务、在线领取分享优惠券、以及发布抽奖、刮奖等趣味互动营销服务。也可通过微信实现CRM客户管理功能，设置智能机器人回答客户咨询，有效对企业客户进行分组管理，精准推送信息，艾米微中心™是通过老客户的口碑带动新客户消费，为企业培养核心用户、增加粘性、改善服务体验、反复消费的微信营销整合平台。</p>
        <p>艾米微中心™名称：Vlianyun，其涵义为Victory Lian Xi，成功的帮助企业在线上线下维护客户。微客，是指移动互联网时代微应用的使用者，如微博、微信、特别是微信用户中的个人用户。艾米微中心™采用达因微营销模型——社会化媒体消费行为分析模型（BPICAS），深入挖掘消费者吃喝玩乐微生活需求，旨在帮助企业开源节流、抓住用户，提升品牌服务，引领营销领域新的革命。</p>
        <h2>研发背景</h2>
        <p>微营销服务商——达因传媒与中国微营销品牌研究中心经过研究在国内首次提出了社会化媒体新生态对应的消费轨迹与行为模型-- BPICAS达因模型，即创建形象（Build）—定位（Positioning）—兴趣（Interest）—沟通互动服务（Connect&amp; Engage）—行动（Action）— 分享（Share） ，实现品牌口碑快速传播。并以达因传播模型为依据推出了微信营销行业解决方案——艾米微中心™，为企业打造低成本高效的微营销品牌之路</p>
        <h2>艾米微中心™研发中心 </h2>
        <p>杭州艾米微中心™软件技术有限公司，作为以技术、研发为主的上海市高科技软件企业，聚集一批高精尖的网络技术精英，致力于社会化网络行为智能匹配方法与系统SNBIMMS的研究与开发，并依此为基础开发微信营销行业解决方案，目前主要从事艾米微中心™系列产品与服务的研发项目。</p>
        <h2>艾米微中心™营销中心</h2>
        <p>达因传媒，是国内领先的创新型微营销解决方案服务商。艾米微中心™为达因传媒旗下品牌。达因广告传媒（上海）有限公司（Dyne advertising media (shanghai) co.,Ltd），简称“达因传媒”。“达因”一词来自物理学中最小的力学单位Dyne，100000dyn=1N（牛顿），寓意激活并凝聚微小的力量成就最大的品牌影响力。</p>
        <h2>中国微营销品牌研究中心</h2>
	...
	<div class="footer-nav clearfix">
		<div class="wrap clearfix">
			...
			<dl class="list-icon">
				...
				<dd class="icon-mail"><a href="mailto:1731360691@b.qq.com">1731360691@b.qq.com</a></dd>
			</dl>
			<dl class="list-link">
				<dt>友情链接</dt>
				<dd>
			<a href="http://www.ktvcity.com/" target="blank">KTV技术联盟</a>
...
<div class="mod-tools" id="tools">
    <a class="tools-qq" id="launch_qq">QQ:1731360691</a>
  ...
  <div class="mod-page-circle page-index" id="page-index">
    <ul class="nav">
      ...
      <li><a href="#index-2">2<i></i><span>谁使用了爱微CMS</span></a></li>
    </ul>
  </div>
